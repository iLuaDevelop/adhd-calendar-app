...
var fs = require("fs");
var envPaths = [
  import_path.default.join(__dirname, "..", ".env.local"),
  // Development
  import_path.default.join(process.cwd(), ".env.local"),
  // CWD
  import_path.default.join(import_electron.app.getAppPath(), ".env.local")
  // Packaged app
];
var envLoaded = false;
...
console.error("[Main] \u{1F680} MAIN PROCESS STARTED");
...
var menu = import_electron.Menu.buildFromTemplate([
  {
    label: "File",
    submenu: [
      {
